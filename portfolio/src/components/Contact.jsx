  ...
  return (
    <div className="container mx-auto">
      <div className="bg-white rounded-lg shadow p-6 max-w-2xl">
        ...
        <p className="mt-2 text-gray-700">Email: <a href="mailto:thiruththanikan2003@gmail.com" className="text-primary">thiruththanikan2003@gmail.com</a></p>
        <p className="text-gray-700">Phone: <a href="tel:+94765608896" className="text-gray-800">+94 765608896</a></p>

        <form className="mt-4 grid gap-3" onSubmit={(e)=>{e.preventDefault(); alert('Message sent (demo)')}}>
          <input className="border p-3 rounded" placeholder="Your name" required />
          <input className="border p-3 rounded" placeholder="Your email" type="email" required />
          <textarea className="border p-3 rounded" placeholder="Message" rows={5} required />
          <div>
            <button className="bg-primary text-black px-4 py-2 rounded">Send Message</button>
          </div>
        </form>

        <div className="mt-4 flex gap-4 items-center">
          <a href="https://github.com/thiruththanikan?tab=repositories" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-700 hover:text-primary">
          ...
          <a href="https://www.linkedin.com/in/thiruththanikan17" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-700 hover:text-primary">
